...
import ButtonSort from "../TasksSection/ButtonSort";
      ...
      >
        ...
        <li>
          <button
            ...
            className={`border-2 border-slate-300 text-slate-400 w-full rouned-lg 
            border-dashed transition hover:bg-slate-300 hover:text-slate-500
